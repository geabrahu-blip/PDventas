...
import { getStores, addStore, deleteStore, getUsers, deleteUser, updateUser, clearAllData } from '../services/db';
import { MapPin, Plus, Trash2, User as UserIcon, Shield, AlertTriangle, Edit2 } from 'lucide-react';
...
const Stores = () => {
  ...
  const handleSaveUserStore = async (e: React.FormEvent) => {
    e.preventDefault();
    ...
    try {
      ...
      setEditingUser(null);
      loadData();
      alert('Sucursal del usuario actualizada con éxito.');
    } catch (error) {
      ...
      {isEditUserModalOpen && editingUser && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 backdrop-blur-sm">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleSaveUserStore} className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Si dejas esto en "Ninguna / Todas", el vendedor podrá ver el inventario global pero no podrá realizar ventas vinculadas a una tienda física.
                </p>
              </div>
